...
For analytics, we use [DataBuddy](https://databuddy.cc), a cookie-free, GDPR-compliant analytics service. DataBuddy does not use cookies, does not collect personal data, and does not track individual users across sessions. Because no cookies are used for analytics, no cookie consent banner or opt-out mechanism is required.
